...
\begin{tikzpicture}
\pgfmathsetmacro\SheetNumber{\value{ProblemNumber}}	%Sheet 0 is the cover sheet
...
\pgfmathsetmacro{\NumKites}{\NumKitesList[\StaNumber]}
...
\pgfmathsetmacro{\ShowPointingBoxes}{\ShowPointingBoxesList[\StaNumber]}
\ifthenelse{\ShowPointingBoxes = 0}{\def\PointingBoxHeight{0}}{\def\PointingBoxHeight{2.5}}
...
\draw (-\CardHalfWidth,-\CardHalfHeight) -- (\CardHalfWidth,-\CardHalfHeight) --  (\CardHalfWidth,\CardHalfHeight) --  (-\CardHalfWidth,\CardHalfHeight) -- cycle;
