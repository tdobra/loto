...
%Set map position according to size of control descriptions for first problem
\pgfmathsetmacro{\DescriptionHeight}{\DescriptionHeightList[\StaNumber][0]}
\pgfmathsetmacro{\DescriptionWidth}{\DescriptionWidthList[\StaNumber][0]}
}{
...
\pgfmathsetmacro{\DescriptionBaseyCoordinate}{\MapCentreyCoordinate-1.5*\DescriptionHeight}
...
\begin{scope}[shift={(\DescriptionLeft,\DescriptionBaseyCoordinate)}]
\ifthenelse{\SheetNumber = 0}{
\draw (0,0) rectangle (\DescriptionWidth,\DescriptionHeight);
% Print TCTemplate stamp
\node[anchor=north west] at (0,0) {\fontsize{0.25cm}{0.25cm}\selectfont Made in TCTemplate};
}{
...
% Print TCTemplate stamp
%\ifthenelse{\SheetNumber = 0}{
%\node[anchor=north west] at (\DescriptionLeft,\CircleRadius) {\fontsize{0.35cm}{0.35cm}\selectfont Made in TCTemplate};
%}{}
