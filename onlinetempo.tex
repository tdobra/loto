...
% Print MAT stamp
\node[anchor=north west] at (0,0) {\fontsize{0.25cm}{0.25cm}\selectfont Made in MAT};
}{
...
% Print MAT stamp
%\ifthenelse{\SheetNumber = 0}{
%\node[anchor=north west] at (\DescriptionLeft,\CircleRadius) {\fontsize{0.35cm}{0.35cm}\selectfont Made in MAT};
%}{}
